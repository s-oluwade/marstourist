            ...
            {(!loadingUser && !user && !loadingAdmin && !admin) ?
                    ...
                    <div className="hero min-h-full">
                        ...
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md -mt-20">
                                ...
                                <p className="mb-5">Here on the red planet, you will find visitors hailing from various parts of the Galaxy. To get started, click the link below to read their feeds or sign in to visit our store!</p>
                                {showLogin ?
                ...
                <section className="w-full bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
                    <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                        ...
                        <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Here on the red planet, you will find visitors hailing from various parts of the Galaxy. To get started, click the link below to read their feeds or visit our store!</p>
