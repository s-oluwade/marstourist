...
const IndexPage = () => {
    ...
    return (
        <section className="w-full bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1573588028698-f4759befb09a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80')] bg-gray-700 bg-blend-multiply">
            <div className="px-4 mx-auto max-w-screen-xl text-center py-24 md:py-56 h-full flex flex-col justify-center -mt-12">
                ...
                {(!loadingUser && !user && !loadingAdmin && !admin) ?
                    showLogin ?
                        ...
                        <div className="flex justify-center gap-6">
                            ...
                            <Link to={'/forum'} className="btn btn-glass dark:btn-neutral normal-case text-base font-medium">
                                See Martian Forum
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
