...
const UserHomeSubPage = () => {
    ...
    return (
        <div id="user_post" className="p-6 inline-flex flex-col items-center bg-base-100 rounded-md min-h-[800px] shadow-sm">
            ...
            <div id="user_poster" className="bg-base-100 mb-8 rounded-lg">
