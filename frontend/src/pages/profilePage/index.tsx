    ...
    return (
        <div className="flex w-full justify-center pt-2">
            <div className="grid grid-cols-7 w-full max-w-screen-xl">
                <div className="col-span-2 bg-base-100 m-4 rounded">
                    <div id="user_detail" className="flex flex-col items-center xl:flex-row justify-evenly pt-6">
                        <div id="user_brief" className="flex w-full justify-center gap-2 items-center">
                            <div className="avatar">
                                <div className="w-16 rounded-full">
                                    <img src={`http://localhost:4000/${user?.photo}`} />
                                </div>
                            </div>
                            <div className="flex flex-col text-sm gap-1 items-center xl:items-start">
                        ...
                        <ul className="py-6 text-sm w-full">
                            <li className="w-full px-4 py-2 border-b">
                                <h6 className="text-sm font-bold mb-1">Location</h6>
                                <p className="capitalize">{user?.location || "_"}</p>
                            </li>
                            <li className="w-full px-4 py-2 border-b">
                                <h6 className="text-sm font-bold mb-1">Bio</h6>
                                <p>{user?.bio || "_"}</p>
                            </li>
                        </ul>

                        {/* <div id="user_bio" className="p-6 text-left w-full text-sm">
