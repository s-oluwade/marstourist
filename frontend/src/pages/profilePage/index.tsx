        ...
        <div className="mx-auto md:w-[50rem] lg:w-[70rem] mt-4">
            <div className="flex overflow-x-hidden w-full max-w-screen-xl">
                <div className="hidden md:block md:basis-1/4">
                    <div id="side-nav" className="bg-base-100 dark:bg-gray-800 m-4 rounded-md shadow-md min-h-[48.75rem] min-w-[12rem] border-2 border-accent">
                        <div id="user_detail" className="flex flex-col items-center justify-evenly pt-6">
                            ...
                            <ul className="py-6 text-sm w-full">
                                <li className="w-full px-4 py-2 border-b dark:border-b-gray-700">
                                ...
                                <li className="w-full px-4 pt-6 dark:border-b-gray-700">
                                    <p className="">Credits: {user.credit ? user.credit.toFixed(3) : 0} MARS</p>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul className="menu rounded">
                                <li className="group dark:hover:bg-neutral">
                                    <Link className={homepaths.includes(currentPath) ? "active" : ""} to={'/profile/home'}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 group-hover:dark:text-neutral-content">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                        </svg>
                                        <span className="group-hover:dark:text-neutral-content">Home</span>
                                    </Link>
                                </li>
                                <li className="group dark:hover:bg-neutral">
                                    <Link className={inboxpaths.includes(currentPath) ? "active" : ""} to={'/profile/inbox'}>
                                        ...
                                        <div className="indicator">
                                            ...
                                            <span className="group-hover:dark:text-neutral-content">Inbox</span>
                                        </div>
                                    </Link>
                                </li>
                                <li className="group dark:hover:bg-neutral">
                                    <Link className={settingspaths.includes(currentPath) ? "active hover:bg-neutral" : ""} to={'/profile/settings'}>
                                        ...
                                        <span className="group-hover:dark:text-neutral-content">Settings</span>
                                    </Link>
                                </li>
                            </ul>
                        </div>
            ...
            <footer className="w-full bg-transparent mt-6 mb-4">
                <div className="w-full pl-6 md:flex md:items-center md:justify-end gap-6">
                    <span className="text-xs text-neutral/80 sm:text-center dark:text-neutral-content/90">
                        © 2023 Samuel Oluwade
                    </span>
                    <ul className="flex flex-wrap items-center mt-3 text-xs font-medium text-neutral/50 dark:text-neutral-content/90 sm:mt-0">
                        <li>
