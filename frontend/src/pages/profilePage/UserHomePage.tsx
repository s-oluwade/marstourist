    ...
    return (
        <>
            <div className='flex'>
                <div
                    id='user_post'
                    className='m-4 grow items-center bg-base-200 p-6 shadow-sm dark:bg-gray-800 md:max-h-[48.75rem] md:overflow-y-auto md:overflow-x-hidden'
                >
                    ...
                    <div id='user_posts' className=''>
                        {userPosts.map((post, index) => (
                            <div
                                key={index}
                                className='my-4 rounded-lg border bg-base-100 p-3 shadow-md dark:border-neutral dark:bg-gray-700'
                            >
                                <div className='flex w-full items-center justify-between border-b border-b-accent pb-2'>
                                    <div className='flex items-center space-x-3'>
                                        ...
                                        <div className='text-md font-normal capitalize text-neutral dark:text-neutral-content'>
                                            {user?.fullname}
                                        </div>
                                    </div>
                                    <div className='flex items-center space-x-2'>
                                        {!!post.topic && (
                                            <div className='badge badge-outline h-fit w-min md:w-max'>
                                                {post.topic}
                                            </div>
                                        )}
                                ...
                                <div className='mb-2 mt-4 flex justify-between gap-8'>
                                    ...
                                    {postNames && (
                                        <div
                                            ...
                                            } tooltip-close tooltip-left z-[100000]`}
                                            data-tip={post.likes
                ...
                <div className='m-4 hidden max-h-[51.875rem] w-64 min-w-[12.5rem] overflow-y-auto overflow-x-hidden rounded-md bg-neutral/50 shadow-md dark:bg-gray-800 lg:block'>
