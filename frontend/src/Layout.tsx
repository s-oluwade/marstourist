                ...
                <>
                    <div className="drawer">
                        ...
                        <div className="drawer-side z-20">
                            ...
                            <ul className="menu p-4 h-full bg-base-200">
                                ...
                                <div className="flex flex-col w-full justify-center gap-6 items-center">
                                    ...
                                    <ul className='space-y-2 font-medium w-full'>
                                        <li>
                                            <Link to={'/forum'} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                ...
                                                <span className="flex-1 ml-3 whitespace-nowrap">Forum</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to={'/store'} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        ...
                                        {!user &&
                                            <li>
                                                <Link to={'/login/user'} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        ...
                                        {user &&
                                            <li>
                                                <a onClick={userLogout} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
