                                    ...
                                    {window.location.pathname.includes("/profile") &&
                                        <div id="user_menu" className="flex flex-col gap-2 pt-4 ">
                                            ...
                                            <ul className="menu rounded">
                                                <li className='group dark:text-neutral-content/60'>
                                                    <Link className={homepaths.includes(currentPath) ? "active" : ""} to={'/profile/home'}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 group-hover:text-neutral-content">
                                                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                                        </svg>
                                                        <span className='group-hover:text-neutral-content'>Home</span>
                                                    </Link>
                                                </li>
                                                <li className='group dark:text-neutral-content/60'>
                                                    <Link className={inboxpaths.includes(currentPath) ? "active" : ""} to={'/profile/inbox'}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 group-hover:text-neutral-content">
                                                        ...
                                                        <div className="indicator">
                                                            ...
                                                            <span className='group-hover:text-neutral-content'>Inbox</span>
                                                        </div>
                                                    </Link>
                                                </li>
                                                <li className='group dark:text-neutral-content/60'>
                                                    <Link className={settingspaths.includes(currentPath) ? "active" : ""} to={'/profile/settings'}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 group-hover:text-neutral-content">
                                                        ...
                                                        <span className='group-hover:text-neutral-content'>Settings</span>
                                                    </Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <ul className='space-y-2 font-medium w-full'>
                                        <li>
                                            <Link to={'/forum'} className="flex items-center p-2 text-neutral rounded-lg dark:text-base-300 hover:bg-gray-100 group">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 dark:group-hover:text-gray-200">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                                                </svg>
                                                <span className="flex-1 ml-3 whitespace-nowrap dark:group-hover:text-gray-200">Forum</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to={'/store'} className="flex items-center p-2 text-neutral rounded-lg dark:text-base-300 hover:bg-gray-100 group">
                                                ...
                                                <span className="flex-1 ml-3 whitespace-nowrap dark:group-hover:text-gray-200">Shop</span>
                                            </Link>
                                        </li>
                                        {!user &&
                                            <li>
                                                <Link to={'/login/user'} className="flex items-center p-2 text-neutral rounded-lg dark:text-base-300 hover:bg-gray-100 group">
                                                    ...
                                                    <span className="flex-1 ml-3 whitespace-nowrap dark:group-hover:text-gray-200">Sign In</span>
                                                </Link>
                                            </li>
                                        }
                                        {user &&
                                            <li>
                                                <a onClick={userLogout} className="flex items-center p-2 text-neutral rounded-lg dark:text-base-300 hover:bg-gray-100 group">
                                                    ...
                                                    <span className="flex-1 ml-3 whitespace-nowrap dark:group-hover:text-gray-200">Sign Out</span>
                                                </a>
                                            </li>
                                        }
                                    </ul>
