...
export default function ProductQuickview({ title, price, images, _id }: ProductWithId) {
	...
	return (
		<Transition.Root show={showProductQuickview} as={Fragment}>
			<Dialog as="div" className="relative z-10" onClose={setShowProductQuickview}>
				<Transition.Child
					as={Fragment}
							...
							<Dialog.Panel className="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
								<div className="relative flex w-full items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
									<button
										...
										onClick={() => setShowProductQuickview(false)}
									>
									...
									<div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
										<div className="aspect-h-3 aspect-w-2 overflow-hidden rounded-lg bg-gray-100 sm:col-span-4 lg:col-span-5">
											<img src={images[0]} alt={title} className="object-cover object-center" />
										</div>
